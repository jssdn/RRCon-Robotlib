/**
    ...
    @brief [HEADER] Driver for I2C LIS3LV02DL Accelerometer
*/
...
#define LIS3_ID 0x3a /*! Control register 2 */
...
typedef struct{
    //Driver
    I2CDEV* i2c; ///< I2C device where the accelerometer is connected
    uint8_t address; ///< I2C address of the accelerometer
    RT_MUTEX mutex; ///< Xenomai Mutex
    //Data
    int16_t xacc; ///< Last latched acceleration in X
    int16_t yacc; ///< Last latched acceleration in Y
    int16_t zacc; ///< Last latched acceleration in Z
    //Calibrated data
    int16_t xcal; ///< Calibrated acceleration in X
    int16_t ycal; ///< Calibrated acceleration in Y
    int16_t zcal; ///< Calibrated acceleration in Z
    
    char data_overrun; ///< Data overrun on the accelerometer
} LIS3LV02DL;
